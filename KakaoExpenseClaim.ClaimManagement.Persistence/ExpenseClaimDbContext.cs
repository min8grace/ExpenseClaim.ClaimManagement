...
namespace KakaoExpenseClaim.ClaimManagement.Persistence
{
    public class ExpenseClaimDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 2, Title = "Expense Claim case 2", TotalAmount = 27098, Status = Status.Requested, RequesterId = 21000319, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 3, Title = "Expense Claim case 3", TotalAmount = 60227, Status = Status.Requested, RequesterId = 21000812, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 4, Title = "Expense Claim case 4", TotalAmount = 5840, Status = Status.Requested, RequesterId = 21000546, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 5, Title = "Expense Claim case 5", TotalAmount = 16434, Status = Status.Requested, RequesterId = 21000173, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
