...
namespace KakaoExpenseClaim.ClaimManagement.Persistence
{
    public class ExpenseClaimDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 6, Title = "Expense Claim case 6", TotalAmount = 63415, Status = Status.Requested, RequesterId = 21000986, SubmitDate = DateTime.Now.AddMonths(3), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 7, Title = "Expense Claim case 7", TotalAmount = 77098, Status = Status.Requested, RequesterId = 21000319, SubmitDate = DateTime.Now, RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 8, Title = "Expense Claim case 8", TotalAmount = 10227, Status = Status.Requested, RequesterId = 21000812, SubmitDate = DateTime.Now, RequesterComments = "please, check this out and approve it	" });
            ...
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 10, Title = "Expense Claim case 10", TotalAmount = 76434, Status = Status.Requested, RequesterId = 21000173, SubmitDate = DateTime.Now, RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 11, Title = "Expense Claim case 11", TotalAmount = 50915, Status = Status.Requested, RequesterId = 21000986, SubmitDate = DateTime.Now, RequesterComments = "please, check this out and approve it	" });
