...
namespace KakaoExpenseClaim.ClaimManagement.Persistence
{
    public class ExpenseClaimDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 5, Title = "Expense Claim case 5", TotalAmount = 16434, Status = Status.Requested, RequesterId = 21000986, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 6, Title = "Expense Claim case 6", TotalAmount = 63415, Status = Status.Requested, RequesterId = 21000986, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 7, Title = "Expense Claim case 7", TotalAmount = 77098, Status = Status.Requested, RequesterId = 21000319, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 8, Title = "Expense Claim case 8", TotalAmount = 10227, Status = Status.Requested, RequesterId = 21000812, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 9, Title = "Expense Claim case 9", TotalAmount = 3840, Status = Status.Requested, RequesterId = 21000546, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 10, Title = "Expense Claim case 10", TotalAmount = 76434, Status = Status.Requested, RequesterId = 21000173, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 11, Title = "Expense Claim case 11", TotalAmount = 50915, Status = Status.Requested, RequesterId = 21000986, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 12, Title = "Expense Claim case 12", TotalAmount = 97098, Status = Status.Requested, RequesterId = 21000319, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 13, Title = "Expense Claim case 13", TotalAmount = 80227, Status = Status.Requested, RequesterId = 21000812, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 14, Title = "Expense Claim case 14", TotalAmount = 4840, Status = Status.Requested, RequesterId =  21000546, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
            modelBuilder.Entity<ExpenseClaim>().HasData(new ExpenseClaim { ExpenseClaimId = 15, Title = "Expense Claim case 15", TotalAmount = 26434, Status = Status.Requested, RequesterId = 21000173, SubmitDate = DateTime.Now.AddMonths(6), RequesterComments = "please, check this out and approve it	" });
